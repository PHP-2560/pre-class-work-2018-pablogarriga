...
```{R echo=TRUE, message=FALSE, warning=FALSE}
print(paste("Add all the integers between 0 and 1000:", 
            sum(seq(0:1000))))
print(paste("Add all the EVEN integers between 0 and 1000:", 
            sum(seq(0,1000,2))))
```
